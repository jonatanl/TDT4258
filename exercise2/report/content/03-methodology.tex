...
\section{Saveing song in memory}
...
In our solution we chose to represent a song as an array of 16 bit int values. Each value represent pitch, octave, amplitude and duration. In table \ref{tab:bitFields} the bit partitions are described. \\

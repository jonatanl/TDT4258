...
\subsubsection{Accessing GPIO pins}\label{sec:gpio-access}
\todo{Write about how GPIO pins are set up}

\subsubsection{Setting up GPIO Interrupts}\label{sec:gpio-interrupts}
\todo{Write about how GPIO interrupts are set up}
